...
class Generate:
	...
	def saveToFile(self, human, computer, humanTest, computerTest, Pe, testProb, numberOfTrainingErrors, numberOfTestErrors):
		np.save('CascadeCodeHuman', human)
		np.save('CascadeCodeComputer', computer)
		np.save('CascadeCodeHumanTest', humanTest)
		np.save('CascadeCodeComputerTest', computerTest)
	...
	def DataGeneration(self,testProb):
		size = 11 #Size of lattice, MUST BE CHANGED WHEN GENERATING NEW DATA.
