...
class RLsys:
	...
	"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
	def __init__(self, actions, state_size, optt='adam', miniBatchSize = 32, TNRate = 50 , memorySize = 2000000, reward_decay=0.99, e_greedy=0.98):
	...
	def learn(self):
		...
		for i in range(self.miniBatchSize):
			...
			if 'terminal' not in observation_p:
